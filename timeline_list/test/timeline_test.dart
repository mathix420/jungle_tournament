...
void main() {
  testWidgets('TimelineModel equality and hashCode',
    ...
    final TimelineModel model1 = TimelineModel(child, child,
        position: TimelineItemPosition.random,
        icon: icon,
        iconBackground: Colors.yellow);
    final TimelineModel model2 = TimelineModel(child, child,
        position: TimelineItemPosition.random,
        icon: icon,
        iconBackground: Colors.yellow);
    final TimelineModel model3 = TimelineModel(child, child,
        position: TimelineItemPosition.left,
        icon: icon,
        iconBackground: Colors.yellow);
    final TimelineModel model4 = TimelineModel(child, child,
        position: TimelineItemPosition.random,
        icon: icon,
        iconBackground: Colors.blue);
    final TimelineModel model5 = TimelineModel(child, child,
        position: TimelineItemPosition.random,
        icon: icon2,
        iconBackground: Colors.yellow);
    ...
    final TimelineModel model6 = TimelineModel(child, child,
        position: TimelineItemPosition.random,
        icon: icon2,
        iconBackground: Colors.blue,
        isFirst: true,
    ...
    final TimelineModel model7 = TimelineModel(child, child,
        position: TimelineItemPosition.random,
        icon: icon2,
        iconBackground: Colors.blue,
        isFirst: false,
    ...
    final TimelineModel model8 = TimelineModel(child, child,
        position: TimelineItemPosition.random,
        icon: icon2,
        iconBackground: Colors.blue,
        isFirst: true,
    ...
    final TimelineModel model9 = TimelineModel(child, child,
        position: TimelineItemPosition.random,
        icon: icon2,
        iconBackground: Colors.blue,
        isFirst: false,
    ...
    final TimelineModel model10 = TimelineModel(child, child,
        position: TimelineItemPosition.random,
        icon: icon2,
        iconBackground: Colors.blue,
        isFirst: true,
  ...
  testWidgets('Single item size', (WidgetTester tester) async {
    await tester.pumpWidget(Directionality(
        ...
        child: Timeline(children: <TimelineModel>[
          TimelineModel(
            Container(key: key, width: 200.0, height: 200.0),
            Container(key: key, width: 200.0, height: 200.0),
          )
        ])));
  ...
  testWidgets('Custom Icon', (WidgetTester tester) async {
    await tester.pumpWidget(Directionality(
        ...
        child: Timeline(
          children: <TimelineModel>[
            TimelineModel(Container(), Container(),
                icon: Icon(
                  Icons.add,
                  color: Colors.yellow,
                ))
  ...
  testWidgets('Reverse List', (WidgetTester tester) async {
    await tester.pumpWidget(Directionality(
        ...
        child: Timeline.builder(
            reverse: true,
            itemCount: 1,
            itemBuilder: (context, i) => TimelineModel(Container(), Container(),
                icon: Icon(
                  Icons.add,
  ...
  testWidgets('Multiple items viewport offset', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Directionality(
        ...
        child: Timeline.builder(
          ...
          itemBuilder: ((context, i) => TimelineModel(
              Placeholder(
